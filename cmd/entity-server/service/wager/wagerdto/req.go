...
type WagerReq struct {
	...
	SellingPrice      float32 `json:"selling_price" valid:"required, MonetaryType, ValidSellingPrice"`
}

type WagerBuyingReq struct {
	WagerID     uint    `json:"wager_id"`
	BuyingPrice float32 `json:"buying_price" valid:"required, MonetaryType"`
}
